...
<div style='margin-left: 20%;margin-right: 20%;'>		
 <form id='resetform'>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" id="email" value='<?php if($_GET["user"]!=null){ echo urldecode($_GET["user"]); } ?>'>
    <input type="hidden" class="form-control" id="code" value='<?php if($_GET["code"]!=null){ echo $_GET["code"]; } ?>'>
  </div>
     <div class="form-group">
         <h5 id='msg'></h5>
         
     </div>
  <button  onclick='updateaccount();' class="btn btn-default">Update</button>
</form> <!-- This is the main div that will be used by angular -->
</div>		
